...
<head>
	...
	<title>Frm_PSInvoiceSale_Back_ABB.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_PSInvoiceSale_Back_ABB.mrt");
			...
			report.dictionary.variables.getByName("SP_tDocNo").valueObject = "S2220003000010000183";
			report.dictionary.variables.getByName("SP_tStaPrn").valueObject = "1";
			report.dictionary.variables.getByName("SP_tGrdStr").valueObject = "สี่ร้อยห้าสิบบาทถ้วน";
