...
<head>
	...
	<title>Frm_SQL_SMPBillStateMent.mrt - Viewer</title>
	...
	<script type="text/javascript">
		function Start() {
			...
			report.loadFile("reports/Frm_SQL_SMPBillStateMent.mrt");
			...
			report.dictionary.variables.getByName("SP_tDocNo").valueObject = "SB0000122000011";
